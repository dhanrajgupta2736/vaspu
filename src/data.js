...
export const VASP_DATA = {
  ...
  scenarios: {
    scenario1: {
      ...
      nodes: [
        { id: "node-1", label: "Victim Deposit", type: "victim", address: "TX9KqPz8vM7L3gN1bX8Vw2Q5jE4tR6uY7a", balance: "0 USDT", tags: ["Reported Address", "NCRP Source"], x: 100, y: 220 },
        { id: "node-2", label: "Layer 1 Burner", type: "burner", address: "TL3rVw8xPq7M9kN1bZ5Q2jE4tR6uY8a9b", balance: "12.4 USDT", tags: ["Temporary Wallet", "Active 18m ago"], x: 340, y: 220 },
        { id: "node-3", label: "Binance Deposit Cluster", type: "vasp", address: "TQ7mPz8vM7L3gN1bX8Vw2Q5jE4tR6uY999", balance: "842,500 USDT", tags: ["VASP Deposit", "Binance Hot Wallet #41", "SAHYOG Active"], x: 620, y: 220 }
      ],
      edges: [
        { from: "node-1", to: "node-2", amount: "5,800 USDT", txHash: "0x8f2a...9c41", time: "18 mins ago", hop: 1 },
        { from: "node-2", to: "node-3", amount: "5,785 USDT", txHash: "0x3e1b...7a82", time: "14 mins ago", hop: 2 }
      ],
      confidenceBreakdown: {
        baseScore: 98,
        hopPenalty: -2,
    ...
    scenario2: {
      ...
      nodes: [
        { id: "s2-n1", label: "Victim Collection", type: "victim", address: "0x71C4b9F39a04a89d2D5167664B29E30A2c7D951B", balance: "0 ETH", tags: ["Reported Wallet"], x: 80, y: 220 },
        { id: "s2-n2", label: "Peel Step 1", type: "layering", address: "0x892aF4...19c2", balance: "2.1 ETH", tags: ["Mule Intermediary"], x: 230, y: 150 },
        { id: "s2-n3", label: "Uniswap V3 Router", type: "dex", address: "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45", balance: "DEX Liquidity", tags: ["DEX Swap", "USDT ➔ ETH"], x: 380, y: 150 },
        { id: "s2-n4", label: "Peel Step 2", type: "layering", address: "0x3eF41...98cD", balance: "1.4 ETH", tags: ["Split Wallet"], x: 530, y: 220 },
        { id: "s2-n5", label: "Consolidation Hub", type: "burner", address: "0x91cA...882E", balance: "0.05 ETH", tags: ["Final Aggregator"], x: 680, y: 220 },
        { id: "s2-n6", label: "CoinDCX Deposit Node", type: "vasp", address: "0x2e7...4F11", balance: "1,240 ETH", tags: ["VASP Deposit", "CoinDCX India", "FIU Registered"], x: 840, y: 220 }
      ],
      edges: [
        { from: "s2-n1", to: "s2-n2", amount: "22.5 ETH", txHash: "0x11a...ef1", time: "1h 12m ago", hop: 1 },
        { from: "s2-n2", to: "s2-n3", amount: "20.4 ETH", txHash: "0x22b...ef2", time: "58m ago", hop: 2 },
        { from: "s2-n3", to: "s2-n4", amount: "52,000 USDT", txHash: "0x33c...ef3", time: "44m ago", hop: 3 },
        { from: "s2-n4", to: "s2-n5", amount: "50,500 USDT", txHash: "0x44d...ef4", time: "25m ago", hop: 4 },
        { from: "s2-n5", to: "s2-n6", amount: "50,450 USDT", txHash: "0x55e...ef5", time: "12m ago", hop: 5 }
      ],
      confidenceBreakdown: {
        baseScore: 95,
        hopPenalty: -12,
    ...
    scenario3: {
      ...
      nodes: [
        { id: "s3-n1", label: "Ransom Payment", type: "victim", address: "0x3A2b9cD1481eE44eF929C8B56149D2F3879b2A40", balance: "0 ETH", tags: ["Victim Address"], x: 120, y: 220 },
        { id: "s3-n2", label: "Staging Wallet", type: "burner", address: "0x77dE...3A99", balance: "0.2 ETH", tags: ["Attacker Staging"], x: 380, y: 220 },
        { id: "s3-n3", label: "Tornado Cash 10 ETH Vault", type: "mixer", address: "0xd90e2f925DA726b50C4Ed8D0Fb90Ad053324F31b", balance: "42,100 ETH", tags: ["OFAC Sanctioned", "Zero-Knowledge Pool", "Trace Degraded"], x: 680, y: 220 }
      ],
      edges: [
        { from: "s3-n1", to: "s3-n2", amount: "60.0 ETH", txHash: "0x991...aa1", time: "3h ago", hop: 1 },
        { from: "s3-n2", to: "s3-n3", amount: "59.8 ETH", txHash: "0x992...aa2", time: "2h 45m ago", hop: 2 }
      ],
      confidenceBreakdown: {
        baseScore: 90,
        hopPenalty: -4,
    ...
    scenario4: {
      ...
      nodes: [
        { id: "s4-n1", label: "Victim Tron Wallet", type: "victim", address: "TN8mL2qPk7Y9jR4vX3Ww5Q1bE8tZ6uA7cB", balance: "0 USDT", tags: ["Tron TRC-20"], x: 100, y: 220 },
        { id: "s4-n2", label: "Stargate Router (Tron)", type: "bridge", address: "0xaf51...4c90", balance: "Bridge Pool", tags: ["Lock/Burn Event", "Stargate Bridge"], x: 340, y: 220 },
        { id: "s4-n3", label: "Arbitrum Relayer Recipient", type: "burner", address: "0x44fB...189a", balance: "45 USDC", tags: ["Arbitrum Mint"], x: 580, y: 220 },
        { id: "s4-n4", label: "WazirX Ingestion Wallet", type: "vasp", address: "0x918E...4A77", balance: "580,000 USDC", tags: ["WazirX Exchange", "FIU-IND Registered", "SAHYOG Active"], x: 820, y: 220 }
      ],
      edges: [
        { from: "s4-n1", to: "s4-n2", amount: "14,500 USDT", txHash: "0x771...bb1", time: "42m ago", hop: 1 },
        { from: "s4-n2", to: "s4-n3", amount: "14,480 USDC", txHash: "0x772...bb2", time: "38m ago", hop: 2 },
        { from: "s4-n3", to: "s4-n4", amount: "14,435 USDC", txHash: "0x773...bb3", time: "29m ago", hop: 3 }
      ],
      confidenceBreakdown: {
        baseScore: 96,
        hopPenalty: -6,
